    ...
    public partial class FormSJF : Form
    {
        ...
        private void InputDataGridViewToArray()
        {
            ...
            for (int i = 0; i < dgvInput.RowCount; i++)
                processes.Add(new Process(
                    ...
                    Convert.ToInt32(dgvInput.Rows[i].Cells[1].Value), // Arrival time
        ...
        private void btnAnswer_Click(object sender, EventArgs e)
        {
            ...
            if (cboType.SelectedIndex == 0)
            {
                ...
                processes = SJFNonPreemptive.AlgorithmProcessing();
            }
            else if (cboType.SelectedIndex == 1)
            {
                SJFPreemptive.processes = processes;
                SJFPreemptive.AlgorithmProcessing();
            }
            PrintArrayToOutput();
            AverageTime();
        }
        ...
        private void btnLang_Click(object sender, EventArgs e)
        {
            ...
            {
                // Form
                lblTitle.Text = Vietnamese.lblTitleSJF;
                lblType.Text = Vietnamese.lblType;
                cboType.Items[0] = Vietnamese.cboTypeItem0SJF;
                cboType.Items[1] = Vietnamese.cboTypeItem1SJF;
            ...
            {
                // Form
                lblTitle.Text = English.lblTitleSJF;
                lblType.Text = English.lblType;
                cboType.Items[0] = English.cboTypeItem0SJF;
                cboType.Items[1] = English.cboTypeItem1SJF;
