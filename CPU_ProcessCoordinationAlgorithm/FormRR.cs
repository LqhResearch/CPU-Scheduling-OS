...
namespace CPU_ProcessCoordinationAlgorithm
{
    public partial class FormRR : Form
    {
        ...
        private void FormRR_Load(object sender, EventArgs e)
        {
            ...
            colOutputArrivalTime.Visible = false;
        ...
        private void SetToolTipEnglish()
        {
            ...
            toolTip.SetToolTip(nudQuantum, "Quantum: usually 10 to 100 milliseconds");
        }
        ...
        private void SetToolTipVietnamese()
        {
            ...
            toolTip.SetToolTip(nudQuantum, "Lượng tử: thường là 10 đến 100 mili giây");
        }
        ...
        private void PrintArrayToOutput()
        {
            ...
            for (int i = 0; i < processes.Count; i++)
            {
                ...
                row.CreateCells(dgvOutput, new object[] { processes[i].ID, processes[i].ArrivalTime, processes[i].BurstTime, processes[i].WaitTime, processes[i].TurnAroundTime });
        ...
        private void btnAnswer_Click(object sender, EventArgs e)
        {
            ...
            RoundRobin.processes = processes;
            RoundRobin.quantum = (int)nudQuantum.Value;
            RoundRobin.AlgorithmProcessing();
            PrintArrayToOutput();
            AverageTime();
        }
        ...
        private void btnLang_Click(object sender, EventArgs e)
        {
            ...
            {
                // Form
                lblTitle.Text = Vietnamese.lblTitleRR;
                lblQuantum.Text = Vietnamese.lblQuantumRR;
            ...
            {
                // Form
                lblTitle.Text = English.lblTitleRR;
                lblQuantum.Text = English.lblQuantumRR;
